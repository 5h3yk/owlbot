  ...
  async execute(interaction) {
    ...
    if (!apiKey) {
      return interaction.reply(
        "Hou-hou, j'ai un petit souci avec l'API de la NASA. 😅"
      )
    }
    ...
    try {
       ...
       * Il faut donc télécharger les images pour les convertir avant de les retourner.
       */
      ...
      const embed = new EmbedBuilder()
        ...
        .setFooter({
          text: data.copyright ? `© ${data.copyright}` : "Domaine public",
        })
      ...
      await interaction.editReply(
        "Houston, nous avons un problème avec l'API de la NASA... 😅 Retente un peu plus tard !"
      )
    }
  },
}
